        ...
        const electionList = this.state.candidates.map(candidates => {
            return (
                <div className="vote-contact" key={candidates.id}>
                    <li className="votecount-avatar">
                        <div className='votecount-top'>
                            <i className="material-icons circle darken-2">ballot</i>
                            <p style={{ fontSize: "1.5rem", marginLeft: "10px" }}><b>{candidates.name}</b></p>
                        </div>
                        {/* <p>{candidates.details}</p> */}
                        <p style={{ color: "#fff" }} className="secondary-content"><b>{candidates.voteCount}</b></p>
                    </li>
                </div>
            )
        })
        return (
            <div className="vote">
                <ul className="vote-container">
                    <h3 style={{ color: "#fff" }}>Candiates</h3>
                    {electionList}
                </ul>
            </div>
