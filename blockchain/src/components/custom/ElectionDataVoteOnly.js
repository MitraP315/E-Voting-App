...
import "./styles.css"
class ElectionDataVoteOnly extends Component {
    ...
    render() {
        const electionList = this.state.final.map(election => {
            return (
                <div className="elections-contact" key={election.election_id}>
                    <li className="elections-avatar">
                        <div className='elections-avatar-top'>
...
export default ElectionDataVoteOnly;